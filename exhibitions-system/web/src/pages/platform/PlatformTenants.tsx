                  ...
                  <div>
                    <p className="flex items-center gap-2 text-text">
                      ...
                      <span className="rounded-full bg-surface-2 px-2 py-0.5 text-[10px] text-muted">
                        {t.business_type === 'restaurant' ? 'مطعم' : t.business_type === 'manufacturing' ? 'تصنيع' : t.business_type === 'distribution' ? 'مورّد مواد غذائية' : t.business_type === 'grocery' ? 'بقالة / سوبر ماركت' : 'تجزئة'}
                      </span>
                    </p>
...
function CreateTenantDialog({
  ...
  const [businessType, setBusinessType] = useState<'retail' | 'grocery' | 'restaurant' | 'manufacturing' | 'distribution'>('retail');
      ...
      <form id="create-tenant-form" onSubmit={submit} className="space-y-4">
        ...
        <Field label="نوع النشاط">
          ...
          >
            ...
            <option value="grocery">بقالة / سوبر ماركت (كاشير باركود)</option>
